...
Else
    ...
    WScript.Echo "1. Boss-Extrude1 SUCCESS: " & featPlate.Name
End If
...
Else
    ...
    WScript.Echo "2. Cut-Extrude1 Pockets SUCCESS: " & featPockets.Name
End If
...
Else
    ...
    WScript.Echo "3. Cut-Extrude2 Holes SUCCESS: " & featHoles.Name
End If
...
Else
    ...
    WScript.Echo "4. Cut-Extrude3 Counterbores SUCCESS: " & featCbores.Name
End If
...
' 6. Force rebuild & check feature errors
swModel.ForceRebuild3 True

' Check errors on features
Dim featList, f
featList = Array(featPlate, featPockets, featHoles, featCbores)
For Each f in featList
    Dim errCode
    errCode = f.GetErrorCode2()
    WScript.Echo "Feature: " & f.Name & " -> ErrorCode: " & errCode
Next
...
WScript.Echo "ALL COMPLETED WITH ZERO ERRORS!"
WScript.Quit 0
